...
export const projectConstellation = [
  {
    ...
    kind: "systems",
    proofImage: "https://raw.githubusercontent.com/Mrudula-itsjuzme/Semantic_Workspace/main/frontend/src/assets/hero.png",
    proofLabel: "frontend hero · current repo asset",
  },
  {
    name: "AnswerBubble",
    href: "https://github.com/Mrudula-itsjuzme/Answer_bubble",
    note: "Desktop AI meeting copilot: live transcription, question detection, floating answers, local memory, and privacy-first processing.",
    kind: "product",
    proofLines: ["<500ms question detection", "multi-provider LLM failover", "no raw audio stored"],
    proofLabel: "repo architecture · no fake screenshot",
  },
  {
    name: "AI Council",
